...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Moengage Actions Tag",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "Tracks Custom events, User attributes using Moengage web SDK",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "selectItems": [
      ...
      {
        "value": "first_name",
        "displayValue": "Track First Name"
      },
      {
        "value": "last_name",
        "displayValue": "Track Last Name"
      },
      {
        "value": "email",
        "displayValue": "Track Email"
      },
      {
        "value": "mobile",
        "displayValue": "Track Mobile"
      },
      {
        "value": "user_name",
        "displayValue": "Track Username"
      },
      {
        "value": "gender",
        "displayValue": "Track Gender"
      },
      {
        "value": "dob",
...
function executeAction() {
  ...
  callInWindow('Moengage.setIntegrationVersion', 2);
  data.gtmOnSuccess();
}
